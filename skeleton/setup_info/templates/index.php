...
<html lang="ja">
  ...
  <body>
    <header>
      <div class="row">
        <?php echo $html->link($html->image('/assets/base/phi/images/logo.png', array('alt' => 'phi')), 'Start', array(), array('escape' => FALSE)) ?>
      </div>
      <h1>設定情報の確認</h1>
    </header>
    <div id="contents">
          ...
          <li>
            ...
            <div class="data-content">
              <?php if (isset($hasDemoApp)): ?>
                ...
                <?php endif ?>
              <?php else: ?>
                <p>デモアプリケーションがインストールされていません。デモアプリケーションを起動するには、'phi install-demo-app' コマンドでインストールを行なう必要があります。</p>
              <?php endif ?>
            </div>
          </li>
        </ul>
