 ...
 * アプリケーション上で認証機能を有効にするには、PHI_DigestAuthenticationFilter を実装したクラスを作成する必要があります。
 ...
 */
abstract class PHI_DigestAuthenticationFilter extends PHI_HttpAuthenticationFilter
{
  /**
