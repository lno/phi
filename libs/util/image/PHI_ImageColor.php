 ...
 * @package util.image
 */
class PHI_ImageColor extends PHI_Object
{
  /**
   * UNIX X11 カラー。
  ...
  /**
   * RGB カラーを元に PHI_ImageColor オブジェクトのインスタンスを生成します。
   *
   * @param int $red RGB カラーモデルにおける赤色。(0～255)
   * @param int $green RGB カラーモデルにおける緑色。(0～255)
   * @param int $blue RGB カラーモデルにおける青色。(0～255)
   * @return PHI_ImageColor PHI_ImageColor のインスタンスを返します。
   */
  public static function createFromRGB($red, $green, $blue)
  {
    return new PHI_ImageColor($red, $green, $blue);
  }

  /**
   * HTML カラーを元に PHI_ImageColor オブジェクトのインスタンスを生成します。
   *
  ...
  public static function createFromHTMLColor($color)
  {
    ...
    return new PHI_ImageColor($rgb[0], $rgb[1], $rgb[2]);
  }
