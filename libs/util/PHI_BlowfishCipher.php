 ...
 * @package util
 */
class PHI_BlowfishCipher extends PHI_Object
{
  /**
   * 暗号モード定数。(ECB)
   */
  ...
  {
    PHI_CommonUtils::loadVendorLibrary('blowfish/blowfish.php');

    if ($secretKey === NULL) {
      $this->_secretKey = PHI_Config::getApplication()->getString('secretKey');
    } else {
