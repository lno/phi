...
class PHI_NumberUtils
{
   ...
   * <code>
   * // (e.g.) 3.7567219556734
   * $float = PHI_NumberUtils::buildRandomFloat(0, 10);
   * </code>
   *
   ...
   * <code>
   * // '1MB'
   * $size = PHI_NumberUtils::formatBytes(1048576, PHI_NumberUtils::DATA_SIZE_MBYTE);
   *
   * // '1024KB'
   * $size = PHI_NumberUtils::formatBytes(1048576);
   * </code>
   *
   * @param int $size ファイルサイズ。単位は Byte。
   * @param string $unit 変換後の単位。PHI_NumberUtils::DATA_SIZE_* 定数を指定。未指定の場合は適切な単位を追加します。
   ...
   * <code>
   * // 104857600
   * $value = PHI_NumberUtils::realBytes('100MB');
   *
   * // 1288490188.8
   * $value = PHI_NumberUtils::realBytes('1.2GB');
   * </code>
   *
