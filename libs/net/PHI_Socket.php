 ...
 * @package net
 */
class PHI_Socket extends PHI_Object
{
  /**
   * ソケットリソース。
   * @var resource
    ...
    $protocol = 'tcp')
  {
    ...
    if (!$socket) {
      ...
      throw new PHI_ConnectException($message, $errorNumber);
    }
   ...
   * @throws PHI_ConnectException 接続が無効な状態の場合に発生。
   */
  private function isAlive()
  {
    if (!is_resource($this->_socket)) {
      throw new PHI_ConnectException('Not connected.');
    }
