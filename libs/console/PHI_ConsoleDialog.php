 ...
 * @package console
 */
class PHI_ConsoleDialog extends PHI_Object
{
 /**
   * @var int
   */
   ...
   *
   * @param int $sendGraphicMode メッセージ装飾子。指定可能なオプションは {@link PHI_ANSIGraphic} クラスを参照。
   */
  ...
  private function decorateMessage($message)
  {
    ...
    if ($this->_sendGraphicMode !== NULL) {
      $message = PHI_ANSIGraphic::build($message, $this->_sendGraphicMode);
    }
