 ...
 * @package validator
 */
class PHI_DateValidator extends PHI_Validator
{
  /**
   ...
   */
  private function validateDateAllow($fieldName, $year, $month, $day, PHI_ParameterHolder $holder)
  {
