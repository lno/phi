<?php
require PHI_LIBS_DIR . '/kernel/path/PHI_Theme.php';
...
class PHI_AppPathManager
{
  ...
  public static function getInstance()
  {
    ...
    if ($instance === NULL) {
      $instance = new PHI_AppPathManager();
    }
   ...
   * パスマネージャを初期化します。
   *
   * @param PHI_ParameterHolder $themeConfig テーマ設定属性。
   */
  public function initialize($themeConfig = NULL)
  {
    if ($themeConfig !== NULL) {
      $this->_theme = new PHI_Theme($themeConfig);
    }
  }

  /**
   * PHI_Theme オブジェクトを取得します。
   *
   * @return PHI_Theme PHI_Theme のインスタンスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string コンソールディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string キャッシュディレクトリの絶対パスを返します。
   */
 ...
 /**
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string コンフィグディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string ライブラリディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string ログディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string テンプレートディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string テーマディレクトリの絶対パスを返します。
   */
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string テンポラリディレクトリの絶対パスを返します。
   */
 ...
 /**
   ...
   *
   * @param string $appendPath 戻り値に追加する追記パス。
   * @return string ベンダーディレクトリの絶対パスを返します。
   */
  ...
  public static function buildAbsolutePath($basePath, $targetPath, $extension)
  {
    ...
    // 絶対パスが含まれる場合は変換を行わない
    if (PHI_FileUtils::isAbsolutePath($targetPath)) {
      $path = $targetPath;
