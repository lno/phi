 ...
 * @package libs.dao
 */
class PHI_ActionRequestsDAO extends PHI_PerformanceAnalyzerDAO
{
  protected $_tableName = 'phi_action_requests';
  ...
  {
    $conn = $this->getConnection();
    $query = 'DELETE mar, msr FROM phi_action_requests mar, phi_sql_requests msr '
