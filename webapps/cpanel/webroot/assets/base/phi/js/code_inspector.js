loadCss('/assets/base/phi/css/app_code_inspector.css');
...
require(["/assets/base/jquery-ui-1.8.16.custom/js/jquery-1.6.2.min.js"], function(someModule) {
  $().ready(function () {
    $(".phi-stack-traces dt").click(function (e) {
    ...
    $('.phi-stack-traces dt').mouseover(function () {
      $(this).css("background-color", "#dddddd");
    });

    $('.phi-stack-traces dt').mouseout(function () {
