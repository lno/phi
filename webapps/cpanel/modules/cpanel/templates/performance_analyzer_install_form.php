...
<html lang="ja">
  <head>
    ...
    <meta charset="UTF-8" />
    <title>cPanel - パフォーマンスアナライザ</title>
  ...
  <body>
    ...
    <div id="contents">
      ...
      <p>
        パフォーマンスアナライザはアプリケーション開発者のためのパフォーマンス計測ツールです。
        フレームワークはクライアントからの要求を解析し、開発者が設計したビジネスロジックを処理した後にレスポンスを返します。
        ビジネスロジックで必要とされる実行コストをグラフィカルに確認することができるため、アプリケーションを開発する上でボトルネックとなるロジックを見つけ出す際に非常に役立つでしょう。
      </p>
      <h2>インストール方法</h2>
