...
<?php echo $html->includeJS('/assets/base/phi/js/jquery_setup.js') ?>
          ...
          <tr class="statement-type-<?php echo $current->statement_type ?>">
            ...
            <td>
              <?php if ($current->prepared_statement): ?>
                <?php echo PHI_StringUtils::truncate($current->prepared_statement, 255) ?>
              <?php else: ?>
                <?php echo PHI_StringUtils::truncate($current->statement, 255) ?>
              <?php endif ?>
            </td>
